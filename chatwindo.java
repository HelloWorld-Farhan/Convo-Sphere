    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (reciverimg != null && !reciverimg.isEmpty()) {
            Picasso.get()
                    ...
                    .error(R.drawable.man) // Show default profile if URL is empty or fails
                    .into(profile);
        } else {
            profile.setImageResource(R.drawable.man); // Set default profile manually
        }
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                database.getReference().child("chats")
                                        ...
                                        .push().setValue(messagess).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            @Override
                                            public void onComplete(@NonNull Task<Void> task) {
                                                // Trigger notification on message send
