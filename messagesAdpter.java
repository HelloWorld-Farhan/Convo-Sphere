...
import static com.example.letss_talk.chatwindo.reciverIImg;
import static com.example.letss_talk.chatwindo.senderImg;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder.getClass() == senderVierwHolder.class) {
            ...
            if (senderImg != null && !senderImg.isEmpty()) {
                Picasso.get()
                        .load(senderImg)
                        .placeholder(R.drawable.man) // While loading
                        .error(R.drawable.man) // If fails
